		...
		<div className="container">
			<div className="row flex-md-row justify-content-md-end align-items-md-center">
				<div className="col-lg-5 col-xl-4">
					...
					<h3 className="sans spacer-b-small">Discover Phuket's 3 Distinct Routes
				...
				<div className="col-lg-5 offset-lg-2">
					<picture>
						<img alt="Krabi Island Drone shot"  className="img-fluid w-100-percent rounded-5" src="/sys_img/img/island_boat.jpg" />
					</picture>
				</div>
			</div>
		</div>
