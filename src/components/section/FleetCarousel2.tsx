...
export default function FleetCarousel2(props:any) {
    const { items } = props;
  return (
    <>
				...
				<div id="Fleet_Carousel" className="carousel slide">
					...
					<div className="carousel-inner">
						<div className="carousel-item active">
							<div className="row justify-content-between">
								<div className="col-7 col-md-4">
									<Image src={"/images/cards/news_ep_1/card-04.png"} className='rounded-xl img-fluid ml-3' alt='Catamaran' width={514} height={499} />
								</div>
						...
						<div className="carousel-item">
							<div className="row justify-content-between">
								<div className="col-7 col-md-4">
								<Image src={"/images/cards/news_ep_1/card-02.png"} className='rounded-xl img-fluid ml-3' alt='Catamaran' width={514} height={499} />
								</div>
								<div className="col-5 col-md-3 col-lg-4 number-stats-parent">
									<div className="number-stats">
										<dl>
						...
						<div className="carousel-item">
							<div className="row justify-content-between">
								<div className="col-7 col-md-4">
								<Image src={"/images/cards/news_ep_1/card-03.png"} className='rounded-xl img-fluid ml-3' alt='Catamaran' width={514} height={499} />
								</div>
								<div className="col-5 col-md-3 col-lg-4 number-stats-parent">
									<div className="number-stats">
										<dl>
						...
						<div className="carousel-item">
							<div className="row justify-content-between">
								<div className="col-7 col-md-4">
								<Image src={"/images/cards/news_ep_1/card-05.png"} className='rounded-xl img-fluid ml-3' alt='Catamaran' width={514} height={499} />
								</div>
								<div className="col-5 col-md-3 col-lg-4 number-stats-parent">
									<div className="number-stats">
										<dl>
